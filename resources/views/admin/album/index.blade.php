                            ...
                            <div class="thumbnail">
                                ...
                                @endif
                                  <div class="caption">
                                    ...
                                    <li data-toggle="modal" data-target="#addPictureModal"  class="btn btn-primary"><i class="fa fa-plus"></i></li>
                                  </div>
                            </div>
                          </div>
                          @endforeach
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span class="text-red">*</span>置顶</label>
                            <div class="col-sm-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <label for="" class="padding_right" >未激活</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><span class="text-red">*</span>置顶</label>
                            <div class="col-sm-8">
                                ...
                                <label for="" class="padding_right" >置顶</label>
                                <input type="radio" name="is_front" value=0 data-name=0>
                                <label for="" class="padding_right" >不置顶</label>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
